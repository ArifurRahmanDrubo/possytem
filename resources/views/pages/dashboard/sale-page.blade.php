...
@section('content')
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 p-1">
                                    ...
                                    <input type="text" class="form-control" id="Pstock" hidden>
    ...
    <script>
        ...
        function add() {
           ...
           }else if (parseFloat(PQty) > Pstock) { // Check if the quantity exceeds available stock
             errorToast("Available stock is less than the entered quantity");
           } 
           else{
        ...
        async function ProductList(){
            ...
            res.data['rows'].forEach(function (item,index) {
                let row=`<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-price="${item['price']}" data-id="${item['id']}" data-stock="${item['stock']}" class="btn btn-outline-dark text-xxs px-2 py-1 addProduct  btn-sm m-0">Add</a></td>
                     </tr>`
